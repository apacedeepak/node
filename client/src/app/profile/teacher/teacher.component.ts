...
this.teacherData = {
    ...
    this.http.post(this.myService.constant.apiURL + 'users/userdetail', params).subscribe(details => {
      ...
      this.teacherDetail = details;
      this.teacherData = this.teacherDetail.response;
this.global.class_teacher = this.teacherDetail.response.staffdetail.class_teacher;
this.global.bank_acc_no = this.teacherDetail.response.staffdetail.bank_acc_no;
this.global.teacher_name = this.teacherDetail.response.staffdetail.name;
this.global.staff_code = this.teacherDetail.response.staffdetail.staff_code;
      this.sectionArr = this.teacherDetail.response.staffdetail.sectionlist;
      this.global.staff_profile_image = this.myService.commonUrl+this.teacherDetail.response.staffdetail.profile_image;
      this.global.profile_image = this.teacherDetail.response.staffdetail.profile_image;
      ...
      // const tab = subjectArr.reduce((acc, value) => {
