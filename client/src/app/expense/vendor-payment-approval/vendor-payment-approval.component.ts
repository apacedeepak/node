...
export class VendorPaymentApprovalComponent implements OnInit {
  ...
  public vendor_approval_title: any = "Vendor Payment Approval";
  public params: any = {};
  ...
  public approvalSearchStatus = [
    { "id": 1, "status_name": 'Pending' }, { "id": 2, "status_name": 'Paid' }, { "id": 3, "status_name": 'Unpaid' }
  ];
  public expDate: any = "";
  ...
  getFromClose() {
    ...
    this.vendor_approval_title = "Vendor Approval List";
    this.getFromSet();
  }
