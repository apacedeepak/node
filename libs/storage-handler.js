...
exports.upload = function(provider, req, res, options, cb) {
  ...
  form.handlePart = function(part) {
    ...
    this._flushing++;
//Dheeraj added below date time as it is same in PHP API
    var file = {
      container: container,
  ...
  /* Below code has been commented by Dheeraj Bisht to get the form fields
   if user doen't send any attachment*/
